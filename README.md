...
_Please note: Sunflow needs API Version 5 of the "unified trading account" of Bybit, and is tested on Ubuntu Server 24.04 LTS running on Amazon Web Services._
